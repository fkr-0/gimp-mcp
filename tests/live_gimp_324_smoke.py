...
def run_docs_check() -> dict[str, Any]:
    ...
    try:
        ...
        tool_count_ok = "146 typed" in readme or "146 tools" in readme
...
def _async_transport_check(config: ServerConfig) -> dict[str, Any]:
    ...
    ok = (
        evidence.get("registered_tool_total") == 146
...
def _docs_contract_check() -> dict[str, Any]:
    ...
    if "146 typed" not in readme:
        failures.append("README does not advertise 146 typed tools")
